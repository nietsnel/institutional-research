...
Lets take a sample of the dataframe that we just named "data_set" and name it "data_set_small".
...
Next lets merge our new "data_set_small" to our dataframe that we named "data_set".
